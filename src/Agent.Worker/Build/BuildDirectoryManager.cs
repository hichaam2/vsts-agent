...
namespace Microsoft.VisualStudio.Services.Agent.Worker.Build
{
    ...
    public sealed class BuildDirectoryManager : AgentService, IBuildDirectoryManager, IMaintenanceServiceProvider
    {
        ...
        public void RunMaintenanceOperation(IExecutionContext executionContext)
        {
            ...
            bool deleteUnusedBuildDir = executionContext.Variables.GetBoolean("maintenance.orphanstalebuilddir.delete") ?? false;
            if (!deleteUnusedBuildDir)
            {
            ...
            int staleBuildDirThreshold = executionContext.Variables.GetInt("maintenance.builddirstale.threshold") ?? 0;
